        ...
        <div className='page-11 relative w-full h-screen overflow-hidden bg-black'>
            <div className='w-full h-full absolute flex items-center justify-center flex-col text-white'>
                <div className='right flex justify-end gap-5 rotate-[-5deg] bold uppercase'>
                    <h1 className='text-8xl flex flex-shrink-0'>hello <span className='stroke'> world</span></h1><h1 className='text-8xl flex flex-shrink-0'>hello world</h1><h1 className='text-8xl flex flex-shrink-0'>hello <span className='stroke'>world</span></h1> <h1 className='text-8xl flex flex-shrink-0'>hello world</h1>
                    <h1 className='text-8xl flex flex-shrink-0'>hello <span className='stroke'> world</span></h1><h1 className='text-8xl flex flex-shrink-0'>hello world</h1><h1 className='text-8xl flex flex-shrink-0'>hello <span className='stroke'>world</span></h1> <h1 className='text-8xl flex flex-shrink-0'>hello world</h1>
                    <h1 className='text-8xl flex flex-shrink-0'>hello <span className='stroke'> world</span></h1><h1 className='text-8xl flex flex-shrink-0'>hello world</h1><h1 className='text-8xl flex flex-shrink-0'>hello <span className='stroke'>world</span></h1> <h1 className='text-8xl flex flex-shrink-0'>hello world</h1>
                </div>
